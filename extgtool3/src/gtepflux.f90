...
!c            subroutine omg2w, n2out, flux_pr
...
! real(kind=r8b), parameter:: a = 6.370d6      !! equatorial radius (m)
...
program gtepflux
  ...
  use util_epf, only: omg2w, n2out, flux_pr
...
!c===
  ...
  write(6, '(2a)') 'opened input zonal wind file: ', trim(iu)
...
!c+++ 
! 'epfy,epfz,epfdiv,epfy0y,epfz0z,epfy2,epfz2,epfdiv2,epfy0y2,epfz0z2'
! 'EPFY,EPFZ,EPFDIV,EPFY0Y,EPFZ0Z,EPFY,EPFZ,EPFDIV,EPFY0Y,EPFZ0Z'
! 'EP flux meridional,EP flux vertical,EP flux divergence,EP flux div.  (y),EP flux div. (z),EP flux meridional,EP flux vertical,EP flux divergence,EP flux div. (y),EP flux div. (z)'
! 'kg/m/s2,kg/m/s2,m/s2,m/s2,m/s2,kg/s2,kg/s2,kg/m/s2,kg/m/s2,kg/m/s2'
!c+++ arguments (default values)
! !c+++
! ofile(1) = 'epfy'                !! output file name
! hitem(1) = 'EPFY'                !! output file item
! htitl(1) = 'EP flux meridional'  !! output file title
! hunit(1) = 'kg/m/s2'             !! output file unit for epfy
! !c+++
! ofile(2) = 'epfz'                !! 
! hitem(2) = 'EPFZ'                !! 
! htitl(2) = 'EP flux vertical'    !! 
! hunit(2) = 'kg/m/s2'             !! output file unit for epfz
! !c+++
! ofile(3) = 'epfdiv'              !! 
! hitem(3) = 'EPFDIV'              !! 
! htitl(3) = 'EP flux divergence'  !! 
! hunit(3) = 'm/s2'                !! output file unit for epfdiv
! !c+++
! ofile(4) = 'epfy0y'              !! 
! hitem(4) = 'EPFY0Y'              !! 
! htitl(4) = 'EP flux div. (y)'    !! 
! hunit(4) = 'm/s2'                !! output file unit for epfy0y
! !c+++
! ofile(5) = 'epfz0z'              !! 
! hitem(5) = 'EPFZ0Z'              !! 
! htitl(5) = 'EP flux div. (z)'    !! 
! hunit(5) = 'm/s2'                !! output file unit for epfz0z
! !c+++
! ofile(6) = 'epfy2'               !! 
! hitem(6) = 'EPFY'                !! 
! htitl(6) = 'EP flux meridional'  !! 
! hunit(6) = 'kg/s2'               !! output file unit for epfy * a
! !c+++
! ofile(7) = 'epfz2'               !! 
! hitem(7) = 'EPFZ'                !! 
! htitl(7) = 'EP flux vertical'    !! 
! hunit(7) = 'kg/s2'               !! output file unit for epfz * a
! !c+++
! ofile(8) = 'epfdiv2'             !! 
! hitem(8) = 'EPFDIV'              !! 
! htitl(8) = 'EP flux divergence'  !! 
! hunit(8) = 'kg/m/s2'             !! output file unit for epfdiv * a * rho0 * cos(lat)
! !c+++
! ofile(9) = 'epfy0y2'             !! 
! hitem(9) = 'EPFY0Y'              !! 
! htitl(9) = 'EP flux div. (y)'    !! 
! hunit(9) = 'kg/m/s2'                !! output file unit for epfy0y * a * rho0 * cos(lat)
! !c+++
! ofile(10)= 'epfz0z2'             !! 
! hitem(10)= 'EPFZ0Z'              !! 
! htitl(10)= 'EP flux div. (z)'    !! 
! hunit(10)= 'kg/m/s2'             !! output file unit for epfz0z * a * rho0 * cos(lat)
...
subroutine xabort
  ...
  write(6, '(a)') '------------------------------------------'
  write(6, '(a)') ' '
  write(6, '(a)') 'ex. for p-levels: gtepflux -u u_P -v v_P -t T_P -omg omg_P'
  write(6, '(a)') ' '
  write(6, '(a)') 'ex. for sigma-levels: gtepflux -u u -v v -t T -omg omg'
  write(6, '(a)') '    -ps Ps -zax siglv -pout GPL31 -pint linear'
  write(6, '(a)') ' '
  write(6, '(a)') 'ex. for eta-levels: gtepflux -u u -v v -t T -omg omg'
