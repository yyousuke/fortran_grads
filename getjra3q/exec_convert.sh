...
#  exec_convert.sh
#  [history]
#  2017/02/08 Yamashita: first ver. for JRA-55 (grd6hr2day)
...
#
#  Defaults:
#   DATADIR_JRA3Q="JRA-3Qデータを置いたディレクトリの絶対パス"
#   idir="${DATADIR_JRA3Q}/grads/6hr"
#   odir_day="${DATADIR_JRA3Q}/grads/daily"
#   odir_mon="${DATADIR_JRA3Q}/grads/monthly"
########################################################################
#
. /etc/bashrc 
#
...
#
# default values
[ -z "${DATADIR_JRA3Q:-}" ] && DATADIR_JRA3Q="path_to_JRA-3Q"
idir="${DATADIR_JRA3Q}/grads/6hr"
odir_day="${DATADIR_JRA3Q}/grads/daily"
odir_mon="${DATADIR_JRA3Q}/grads/monthly"
dayout="f"
